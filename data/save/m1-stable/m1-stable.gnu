...
plot	'm1-stable.csv' using ($1/1000):($2/100) title 'a' with lines ls 1,\
		'm1-stable.csv' using ($1/1000):($3/100) notitle with lines ls 1,\
		'm1-stable.csv' using ($1/1000):($4/100) title 'b' with lines ls 2,\
		'm1-stable.csv' using ($1/1000):($5/100) notitle with lines ls 2,\
		'm1-stable.csv' using ($1/1000):($6/100) title 'c' with lines ls 3,\
		'm1-stable.csv' using ($1/1000):($7/100) notitle with lines ls 3,\
		'm1-stable.csv' using ($1/1000):($8/100) title 'd' with lines ls 4,\
		'm1-stable.csv' using ($1/1000):($9/100) notitle with lines ls 4,\
		'm1-stable.csv' using ($1/1000):($10/100) title 'e' with lines ls 5,\
		'm1-stable.csv' using ($1/1000):($11/100) notitle with lines ls 5
pause -1
