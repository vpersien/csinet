...
public final class Constants {
	...
	public static final double LENITION = 0.0;	// amount of lenition per step
	...
	public static final int TAU = 4000;			// maximum age of an exemplar
...
//	public static final double THRESHOLD = 80.0;
	public static final double SUCCESS = 0.9;	// fraction of exemplars to be categorized right per default
