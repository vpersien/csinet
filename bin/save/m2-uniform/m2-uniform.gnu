...
set label 1 '$x_1$ of a' at 800,0.52 left front textcolor ls 5
set label 2 '$x_1$ of b' at 800,0.26 left front textcolor ls 1
...
plot fname u ($1/1000):($3/100) w lines ls 1,\
     ...
     fname every 40::20 u ($1/1000):($3/100):($2/100):($4/100) notitle with errorbars ls 1 lw 1 pt 0,\
     fname every 40::20 u ($1/1000):($9/100):($8/100):($10/100) notitle with errorbars ls 5 lw 1 pt 0,\
     fname u ($1/1000):($6/100) w lines ls 1,\
     fname u ($1/1000):($12/100) w lines ls 5,\
     fname every 40::40 u ($1/1000):($6/100):($5/100):($7/100) notitle with errorbars ls 1 lw 1 pt 0,\
     fname every 40::40 u ($1/1000):($12/100):($11/100):($13/100) notitle with errorbars ls 5 lw 1 pt 0
