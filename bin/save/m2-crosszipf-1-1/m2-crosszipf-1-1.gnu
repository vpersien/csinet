set output "m2-crosszipf-1-1.tex"
...
set label 1 '$x_1$ of a' at 250,0.16 left front textcolor ls 1
set label 2 '$x_1$ of b' at 250,0.53 left front textcolor ls 5

set label 3 '$x_2$ of a' at 250,0.2 left front textcolor ls 1
set label 4 '$x_2$ of b' at 250,0.48 left front textcolor ls 5

fname = 'm2-crosszipf-1-1-quantiles.csv'

plot fname u ($1/1000):($3/100) w lines ls 1,\
     fname u ($1/1000):($9/100) w lines ls 5,\
     fname every 20::10 u ($1/1000):($3/100):($2/100):($4/100) notitle with errorbars ls 1 lw 1 pt 0,\
     fname every 20::10 u ($1/1000):($9/100):($8/100):($10/100) notitle with errorbars ls 5 lw 1 pt 0,\
